...
export default class OutOfPrayPopup extends BasePopup {
  ...
  create_View() {
    ...
    const text_waiting = this.scene.add.text(bg_item_popup_out_pray1.x + item_icon_offset, bg_item_popup_out_pray1.y + 30, 'Waiting for regenerate', {
    ...
    const text_battle = this.scene.add.text(bg_item_popup_out_pray2.x + item_icon_offset, bg_item_popup_out_pray2.y + 30, 'Win battle to get', {
      fontFamily: 'Mochiy Pop One',
      fontSize: this.nav_font_size,
      color: '#ffffff',
    }).setOrigin(0.5, 0.5);
    ...
    const text_market = this.scene.add.text(bg_item_popup_out_pray3.x + item_icon_offset, bg_item_popup_out_pray3.y + 30, 'Buy in Market', {
      fontFamily: 'Mochiy Pop One',
      fontSize: this.nav_font_size,
      color: '#ffffff',
    }).setOrigin(0.5, 0.5);
